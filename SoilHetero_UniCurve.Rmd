---
title: "Universal Soil Carbon Curves"
...
So, we define a new parameter $\phi = \frac{1}{\alpha-2}$. For interpretation, $\phi$ turns out to be equivalent to the coefficient of variation (CV) squared, and thus we consider $phi$ a dispersion constant. Solving for the parameters and substituting, the integral transform in (3) is now: 
